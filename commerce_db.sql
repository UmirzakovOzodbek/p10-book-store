...
ALTER TABLE public.books_bookauthor OWNER TO saeed;

--
-- Name: books_bookauthor_id_seq; Type: SEQUENCE; Schema: public; Owner: saeed
--

ALTER TABLE public.books_bookauthor ALTER COLUMN id ADD GENERATED BY DEFAULT AS IDENTITY (
...
COPY public.books_bookauthor (id, name, user_id) FROM stdin;
1	Jorch	1
\.
...
ALTER TABLE ONLY public.books_bookauthor
...
CREATE INDEX books_bookauthor_user_id_8520ef80 ON public.books_bookauthor USING btree (user_id);
...
ALTER TABLE ONLY public.books_book
    ADD CONSTRAINT books_book_author_id_8b91747b_fk_books_bookauthor_id FOREIGN KEY (author_id) REFERENCES public.books_bookauthor(id) DEFERRABLE INITIALLY DEFERRED;
